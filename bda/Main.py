...
class Article(object):
  ...
  def __init__(self, article_type, journal_title, article_title, authors, article_categories, chapters):
...
def read_record(xmlns, record):
  ...
  return Article(article_type, journal_title, article_title, authors, article_categories, chapters)
